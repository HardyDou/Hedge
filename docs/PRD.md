...
| 功能 | 描述 | 平台 | 状态 |
|------|------|------|------|
| **两栏主布局** | 左侧列表(280-500px可拖拽) + 右侧详情 | 桌面端 | ✅ |
| **搜索功能** | 实时搜索标题/用户名/备注 | 桌面端 | ✅ |
| **设置弹窗** | 居中模态弹窗，支持外观/安全/关于标签页 | 桌面端 | ✅ |
| **新增/编辑面板** | 左侧滑入面板，无需跳转页面 | 桌面端 | ✅ |
| **系统菜单集成** | Cmd+, 打开设置 (修复 XIB 加载问题) | 桌面端 | ✅ |
| **网站图标** | 使用 CachedNetworkImage 加载 favicon | 桌面端 | ✅ |
| **深色模式** | 自动跟随系统深色/浅色模式 | 桌面端 | ✅ |
